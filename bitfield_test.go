...
func TestFourInt16(t *testing.T) {
	...
	assert.Equal(t, uint64(0b100000000000000001100000000000000100000000000000001), bp.Serialize(&v))
	assert.Equal(t, v, *bp.Deserialize(bp.Serialize(&v)))
}
...
func TestOneInt64(t *testing.T) {
	...
	assert.Equal(t, uint64(0b101010), bp.Serialize(&v))
	assert.Equal(t, v, *bp.Deserialize(bp.Serialize(&v)))
}
...
func TestAllUnsignedTypes(t *testing.T) {
	...
	assert.Equal(t, uint64(0b100101010001000110010100000000000000000110000110101000000), bp.Serialize(&v))
	assert.Equal(t, v, *bp.Deserialize(bp.Serialize(&v)))
}
...
func TestAllSignedTypes(t *testing.T) {
	...
	assert.Equal(t, uint64(0b111010110001000110010100011111111111111001111001011000000), bp.Serialize(&v))
	assert.Equal(t, v, *bp.Deserialize(bp.Serialize(&v)))
}
...
func TestMixed(t *testing.T) {
	...
	assert.Equal(t, uint64(0b111111111111111100000000000000000010001100101000110000000), bp.Serialize(&v))
	assert.Equal(t, v, *bp.Deserialize(bp.Serialize(&v)))
}
...
func TestBooleans(t *testing.T) {
	...
	assert.Equal(t, uint64(0b1010011001), bp.Serialize(&v))
	assert.Equal(t, v, *bp.Deserialize(bp.Serialize(&v)))
}
...
func TestArbitraryBits(t *testing.T) {
	...
	assert.Equal(t, uint64(0b1111111010101), bp.Serialize(&v))
	assert.Equal(t, v, *bp.Deserialize(bp.Serialize(&v)))
}
